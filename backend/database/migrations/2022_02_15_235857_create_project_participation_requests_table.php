...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('project_participation_requests', function (Blueprint $table) {
            $table->id();
            $table->foreignId("project_id")->constrained()->cascadeOnDelete()->comment("参加リクエスト先のプロジェクトid");
            $table->foreignId("user_id")->constrained()->cascadeOnDelete()->comment("参加リクエストしたユーザーid");
