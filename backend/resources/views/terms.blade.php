...
<div class="py-12 text-center">
    <h1 class="deco">利用規約</h1>
</div>

<div class="wrapper mb-20 leading-7 docs">
    <p style="margin-left: 0!important">この利用規約（以下、「本規約」といいます。）は、U-laniwa
        開発者（以下、「当サービス提供者」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
    </p>
    <h2 class="deco" id="1">第 1 条（適用）</h2>
    <ol>
    ...
    <h2 class="deco" id="2">第 2 条（利用登録）</h2>
    <ol>
    ...
    <h2 class="deco" id="3id">第 3 条（ユーザー ID およびパスワードの管理）</h2>
    <p>この条においてのユーザー ID は、ログインや会員登録で用いるメールアドレスと同義です。</p>
    <ol>
    ...
    <h2 class="deco" id="4">第 4 条（禁止事項）</h2>
    <ol>
    ...
    <h2 class="deco" id="5">第 5 条（本サービスの提供の停止等）</h2>
    <ol>
    ...
    <h2 class="deco" id="6">第 6 条（利用制限および登録抹消）</h2>
    <ol>
    ...
    <h2 class="deco" id="7">第 7 条（退会）</h2>
    <ol>
    ...
    <h2 class="deco" id="8">第 8 条（保証の否認および免責事項）</h2>
    <ol>
    ...
    <h2 class="deco" id="9">第 9 条（サービス内容の変更等）</h2>
    <ol>
        <li>当サービス提供者は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。</li>
    </ol>
    <h2 class="deco" id="10">第 10 条（利用規約の変更）</h2>
    <p>当サービス提供者は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお、本規約の変更後、本サービスの利用を開始した場合には、当該ユーザーは変更後の規約に同意したものとみなします。
    </p>
    <h2 class="deco" id="11">第 11 条（個人情報の取扱い）</h2>
    <p>当サービス提供者は、本サービスの利用によって取得する個人情報については、当サービス提供者「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
    <h2 class="deco" id="12">第 12 条（通知または連絡）</h2>
    <p>ユーザーと当サービス提供者との間の通知または連絡は、当サービス提供者の定める方法によって行うものとします。当サービス提供者は、ユーザーから、当サービス提供者が別途定める方式に従った変更届け出がない限り、現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い、これらは、発信時にユーザーへ到達したものとみなします。
    </p>
    <h2 class="deco" id="13">第 13 条（準拠法・裁判管轄）</h2>
    <ol>
